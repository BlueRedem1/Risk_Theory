...
Bajo esta parametrización, $X \sim \text{Binomial Negativa}(k,p)$ con soporte en $X \in \mathbb{N}\{0,1,2,3,4\}$, tenemos que:
\begin{align*}
\mathbb{E}[X] &= \frac{k}{p}\\
&=\frac{5}{\frac{1}{21}}\\
&=5(21)\\
...
&= 4481.18\\
&\therefore \text{La prima a cobrar bajo el método de desviación estándar es 5305.43}_\blacksquare
\end{align*}
